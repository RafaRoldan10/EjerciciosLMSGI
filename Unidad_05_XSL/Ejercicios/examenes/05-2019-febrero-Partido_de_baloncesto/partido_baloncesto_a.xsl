...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <div style="width: 1000px; margin: 0 auto;">
          ...
          <table border="1" width="100%">
            ...
            <xsl:for-each select="equipo">
              <xsl:variable name="equipo"><xsl:value-of select="@imagen"/></xsl:variable>
              ...
              <xsl:apply-templates select="jugador">
                <xsl:with-param name="imagenEquipo"><xsl:value-of select="$equipo"/></xsl:with-param>
  ...
  <xsl:template match="jugador">
    <xsl:param name="imagenEquipo"></xsl:param>
  ...
  <xsl:template match="entrada">
    <tr>
      ...
      <td><xsl:variable name="apodoJugador"/><xsl:value-of select="@jugador"/>
      <xsl:value-of select="/partidoBaloncesto/equipo/jugador[@nombre=$apodoJugador]/@apodo"/>
      </td>
